                ...
                <div className="p-8 bg-slate-50 rounded-[2rem] border border-slate-100 space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-3">
                            ...
                            <div className="p-4 bg-white border border-slate-200 rounded-xl text-text font-medium text-sm flex items-center gap-3">
                    ...
                    <div className="pt-4 p-4 bg-blue-50/50 rounded-xl border border-blue-100">
                        <p className="text-[10px] text-blue-600 font-bold uppercase tracking-widest leading-relaxed">
                            Note: Resume assets are now served statically from the /public directory. Re-upload to public folder to update.
                        </p>
                    </div>
                </div>
            </div>
